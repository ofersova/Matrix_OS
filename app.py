...
st.markdown("""
    ...
    .target-text-green { font-size: 26px; font-weight: bold; color: #00cc00; margin-top: 5px;}
    .target-text-red { font-size: 26px; font-weight: bold; color: #cc0000; margin-top: 5px;}
